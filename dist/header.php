...
<body class="relative bg-gray-100 p-0 m-0 w-screen h-screen overflow-x-hidden  ">
  <section class="lg:fixed md:fixed sticky z-100 mt-0">
  <!-- Top Contact Header -->
  <header class="  bg-[#003366] text-white text-sm w-screen">
...
<div>
  <p class="text-6xl font-bold text-blue-700 hover:text-blue-900 transition-color  ml-10"> WELCOME TO RTC INTER COLLEGE</p>
</div>
  </div>

  <!-- Navigation Menu -->
  <nav class="bg-[#004080] px-4 py-2  w-full">
    <ul class="flex flex-wrap justify-center gap-4 text-white font-medium">
